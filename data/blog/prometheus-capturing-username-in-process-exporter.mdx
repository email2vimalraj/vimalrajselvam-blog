...
summary: Through this post let's learn about capturing user of the process in Process Exporter and leverage the metric_relabel_configs in prometheus to label the username
date: 2020-12-06
