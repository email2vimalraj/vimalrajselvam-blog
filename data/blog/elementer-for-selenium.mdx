...
summary: A chrome extension called Elementer to help in creating page objects for Selenium with ease
date: 2020-04-18
tags: ['test automation', 'qa', 'selenium', 'browser extension']
draft: false
---
...
![Elementer Logo](/static/images/elementer-logo.png)

## Pre-requisite

- Chrome browser
- <a
    href="https://chrome.google.com/webstore/detail/elementer/conbkbehobncjfpbealkoobidhipknok?hl=en"
    target="_blank"
    rel="noopener"
  >
    Elementer Chrome Extension
  </a>
...
![3-SelectLocator](/static/images/3-SelectLocator.png)

Finally, click Add Element button.

![5-AddElementButton](/static/images/5-AddElementButton.png)
...
![6-AddPage-Home](/static/images/6-AddPage-Home.png)

![7-AddElement](/static/images/7-AddElement.png)

![8-AddElement](/static/images/8-AddElement.png)
...
![10-ListPages](/static/images/10-ListPages.png)
...
![14-EditLocale](/static/images/14-EditLocale.png)
