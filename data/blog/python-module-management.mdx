...
summary: Python Module Management
date: 2019-03-04
tags: ['python']
draft: false
---

This post is the continuation of my previous post: [Python Package Management with Pipenv](/blog/python-package-management-with-pipenv). I’ve package / dependency management in place, now I would like to setup the folder structure and get the scripts executed.
...
[![Folder structure](/static/images/python-demo-project-structure.png)](/static/images/python-demo-project-structure.png)
