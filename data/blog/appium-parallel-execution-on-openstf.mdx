...
summary: Setting up the appium to execute tests parallely on various mobiles using OpenSTF
date: 2016-08-07
tags: ['appium', 'test automation', 'qa', 'mobile automation', 'mobile', 'testng']
draft: false
---

In the last [post](/blog/appium-parallel-execution-using-testng), we have seen how to execute appium tests in parallel using Selenium Grid. In this post, I'm going to show you how we can use [OpenSTF](http://openstf.io/), a Smartphone Test Farm - open source tool and execute our tests in parallel.
