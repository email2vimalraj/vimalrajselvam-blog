...
summary: 'Emailable Extent Report for TestNG'
date: 2016-12-24
tags: ['test automation', 'qa', 'extent report', 'testng']
draft: false
---
...
In case you are new to my blog, and wanted to have a look at TestNG Extent Reporter, head [here](/blog/testng-extent-report/) for more details.

## How to generate emailable report?

Follow [here](/blog/testng-extent-report/) to setup. That is all you have to do to generate the `emailable-report.html` in the TestNG's default output folder.
