...
summary: Setting up the appium to execute tests parallely using TestNG and Selenium Grid
date: 2016-07-24
tags: ['appium', 'test automation', 'qa', 'mobile automation', 'mobile', 'testng']
draft: false
---

This is the follow-up post on the [Selenium Grid for Appium mobile automation](/blog/selenium-grid-for-appium-mobile-automation).
