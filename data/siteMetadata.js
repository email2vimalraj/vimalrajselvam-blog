...
const siteMetadata = {
  title: "Vimalraj Selvam's Blog",
  author: 'Vimalraj Selvam',
  headerTitle: 'Vimalraj Selvam',
  description: 'A diary of my learnings',
  language: 'en-us',
  theme: 'system', // system, dark or light
  siteUrl: 'https://vimalrajselvam.com',
  siteRepo: 'https://github.com/email2vimalraj/site',
  siteLogo: `${process.env.BASE_PATH || ''}/static/images/logo.png`,
  socialBanner: `${process.env.BASE_PATH || ''}/static/images/twitter-card.png`,
  mastodon: 'https://mastodon.social/@email2vimalraj',
  ...
  medium: 'https://medium.com/@vimalselvam',
